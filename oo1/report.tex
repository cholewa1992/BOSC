...
Følgende vil havde om hvordan vi har implementeret følgende features.
...
Hvis symbolet {\tt >} optræder i kommandoen skal vi redirecte output til filnavnet på veste side. eg. {\tt cmd > file}. På samme måde skal vi hvis symbolet {\tt <} optræder i kommandoen redirecte input til at være filen fra veste side. eg {\tt cmd < file}. Dette har vi løst med følgende logik.
...
En pipe (skrives med symbol {\tt |}) tager outputtet fra kommandoen på højre side og bruger det som input til kommandoen på venstre side. eg {\tt c1 | c2 | c3 } tager output fra c1 og giver til c2 som input osv. Vi har i vores shell implementeret dette på følgende måde
